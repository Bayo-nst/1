...
echo "\e[37;1m********************* \e[93m GO RANTO\e[37;1m *********************\n";
echo "\e[37;1m*************** \e[93minstagram : @Go Ranto \e[37;1m **************\n";
echo "\e[37;1m****** \e[93mBANTU SAYA MENGEMBANGAKAN CHANNEL SAYA\e[37;1m *******\n";
echo "\e[32;1m*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*\n";
echo "\e[31;1m    || >>>>>>>>\e[1;33m".date('[d-m-Y] [H:i:s]')."\e[31;1m<<<<<<<< ||\n";
echo "\e[32;1m*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*\n";
echo "\e[32;1m*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*\n";
echo "\e[31;1m*•*•*•*•*•*•*•*•*•*•\e[93m GOJEK RANTO  \e[31;1m•*•*•*•*•*•*•*•*•*•*\n";
echo "\e[32;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[93m*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*\n";
...
// function change(){
        ...
        echo color("red","\n▬▬▬▬▬▬▬▬▬▬▬▬* JANGAN LUPA BERDOA *▬▬▬▬▬▬▬▬▬▬▬▬");
       echo "\n".color("purple","# CLAIM VOUCHER BOSS");
       ...
       $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD0607"}');
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
	      gocar:
        echo "\n".color("green","# CLAIM VOUCHER LAGI BOSS");
        echo "\n".color("white","# LAGI DI USAHAKAN BOSS ");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        }
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
        gofood:
        echo "\n".color("white","# CLAIM VOUCHER LAGI BOSS");
        echo "\n".color("green","# SEDEKAH BOSS");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(10);
        }
        ...
        echo "\n".color("yellow","# CLAIM VOUCHER LAGI BOSS");
        echo "\n".color("white","# SANTUY BOSS");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(5);
        }
        ...
        $TOKEN  = "1032900146:AAE7V93cvCvw1DNuTk0Hp1ZFywJGmjiP7aQ";
         ...
         echo color("red","-] Nomor udah Terdaftar Boss.");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
